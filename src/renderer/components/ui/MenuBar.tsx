...
const MenuBar: React.FC = () => {
  ...
  const menuItems = [
    { id: 'file', label: 'File', icon: FileIcon, color: 'var(--text-accent-red)', hoverBg: 'rgba(222, 41, 16, 0.2)' },
    { id: 'edit', label: 'Edit', icon: EditIcon, color: 'var(--text-primary)', hoverBg: 'rgba(255, 255, 255, 0.1)' },
    { id: 'view', label: 'View', icon: ViewIcon, color: 'var(--text-primary)', hoverBg: 'rgba(255, 255, 255, 0.1)' },
    { id: 'window', label: 'Window', icon: WindowIcon, color: 'var(--text-primary)', hoverBg: 'rgba(255, 255, 255, 0.1)' },
    { id: 'help', label: 'Help', icon: HelpIcon, color: 'var(--text-accent-green)', hoverBg: 'rgba(0, 102, 68, 0.2)' },
  ];
      ...
      <div style={{ 
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              {/* Animated background fill with glassmorphism */}
              <div
                style={{
                  position: 'absolute',
                  top: 0,
              ...
              {/* Animated bottom border with Kenyan color */}
              <div
                style={{
                  position: 'absolute',
                  bottom: 0,
